            ...
            <div class="col-12 pt-lg-3">
                <div class="section_top">
                    <div class="text_part text-center">
                      <h2 class="section_heading primary-text" >{{$service?->name}}</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="row photos pt-2">
                  @foreach ($service->service_images as $image)
                    <div class="col-sm-6 col-md-4 col-lg-3 item" data-aos="fade-up" data-aos-delay="200"><a href="{{ $image?->show_image }}" data-lightbox="photos"><img class="img-fluid service-details-item-img" src="{{ $image?->show_image }}"></a></div>
                  @endforeach
                </div>
